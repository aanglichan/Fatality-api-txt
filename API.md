...
| Name | Type | Description |
|------|------|-------------|
| p | vec2 | Text origin point. |
| text | string | Text. |
| c | color | Text color. |
| params | text_params? | Text aligning parameters. Defaults to  nil  . |
...
Every object, that inherits from this type,  must  be ` create ` d before use. The rendering system will only create them automatically, if you happen to lose a device object (e.g. minimize the game window, and then restore it) and  only  if you add your objects to manage table in  ` draw `  . 
...
| Name | Type | Description |
|------|------|-------------|
| value | vec2 | Mins vector, maxs vector. |
...
| Name | Type | Description |
|------|------|-------------|
| mins | vec2 | Mins vector. |
| maxs | vec2 | Maxs vector. |
...
| Name | Type | Description |
|------|------|-------------|
| other | vec2 | Vector to check against. |
...
| Name | Type | Description |
|------|------|-------------|
| v | text_alignment | Vertical alignment. |
...
| Name | Type | Description |
|------|------|-------------|
| h | text_alignment | Horizontal alignment. |
...
| Name | Type | Description |
|------|------|-------------|
| line | text_alignment | Line alignment. |
...
| Name | Type | Description |
|------|------|-------------|
| data | ptr | Pointer to texture  file  data in memory. |
...
| Name | Type | Description |
|------|------|-------------|
| data | ptr | Pointer to  RGBA  data in memory. |
| w | int | Width. |
...
| fl | font_flags | Font flags. Use  bit  library to construct them. Defaults to  0  . |
...
| Name | Type | Description |
|------|------|-------------|
| mem | ptr | Pointer to a font  file  in memory. |
...
| Name | Type | Description |
|------|------|-------------|
| notif | notification | Notification object. |
...
| Name | Type | Description |
|------|------|-------------|
| ctrl | control | Control to remove. |
...
| ico | texture? | Icon. Defaults to  nil  . |
...
> ###  note 
> 
> Formatting uses standard ` printf ` syntax.  Documentation 
...
| col | color? | Label color. Defaults to  nil  . |
